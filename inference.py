...
def main():
    ...
    model_path = "./checkpoints/2020-11-13/db_167_1.9499_1.9947.h5"

    img_dir = './DBNet/datasets/test/input'
    ...
    for img_name in tqdm(img_names):
        ...
        cv2.imwrite('./DBNet/datasets/test/output/' + image_fname, src_image)
